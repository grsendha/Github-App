...
const SignUpPage = () => {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0 border">
      <div className="w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 border bg-glass">
